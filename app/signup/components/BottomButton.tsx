    ...
    <div className="fixed bottom-4 w-full px-6 z-100">
      {stage === 0 && (
        <div className="w-full flex justify-between">
          ...
          <button
            className="bg-[#093AEE] text-[17px] text-[#fff] font-[500] py-4 w-[64%] rounded-[999px]"
            onClick={nextStage}
          >
            인증 번호 받기
          </button>
      ...
      {stage === 1 && (
        <div className="w-full flex justify-between">
          ...
          <button
            className="bg-[#F59E0B] text-[17px] text-[#fff] font-[500] py-4 w-[64%] rounded-[999px]"
            onClick={nextStage}
          >
            다음
          </button>
      ...
      {stage === 2 && (
        <div className="w-full flex justify-center">
          <button
            className="bg-[#10B981] text-[17px] text-[#fff] font-[500] py-4 w-[80%] rounded-[999px]"
            onClick={nextStage}
          >
            인증 완료
          </button>
