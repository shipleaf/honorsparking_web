  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-8 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-3 gap-6 items-start">
        ...
        {/* Column 1: Typography + Text Color + Font Weight */}
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              {(["h1","h2","h3","h4","h5","h6","h7","body","sm","xs"] as const).map((v) => (
                <div key={v} className="flex items-baseline gap-3">
                  <Text variant="xs" color="disabled" className="w-8 shrink-0">{v}</Text>
                  <Text variant={v}>텍스트 샘플</Text>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="bg-grey-900 px-3 py-1.5 rounded-lg w-fit">
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              {(["regular","medium","semibold","bold"] as const).map((w) => (
                <Text key={w} variant="body" weight={w}>{w} — 주차 관리</Text>
              ))}
            </div>
          </section>
        </div>

        {/* Column 2: Button + Modal */}
        <div className="flex flex-col gap-6">
          <section className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="border border-grey-200 rounded-xl overflow-hidden flex flex-col">
